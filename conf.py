...
tags_included = {'tutor-to-hand', 'gives pp counters', 'reanimate-cast', 'creature type erratum', 'gives indestructible', 'anthem', 'removal-creature-burn', 'utility mana rock', 'graveyard fuel-self', 'boost-toughness', 'out of color token', 'sacrifice self', 'tutor-land-basic', 'synergy-planeswalker', 'mana value matters', 'card advantage (no-draw)', 'untaps self', 'activate from hand', 'reflexive trigger', 'synergy-attacker', 'tribal-human', 'power matters-self', 'ferocious', 'gains indestructible', 'sacrifice outlet-enchantment', 'unique token', 'tribal-army', 'sweeper-creature-toughness', 'removal-enchantment-destroy', 'virtual legendary', 'gives menace', 'gains pp counters', 'loot', 'thoughtseize', 'untapper-creature', 'namesake-spell', 'single target instant/sorcery', 'death trigger-self', 'adds multiple mana', 'reanimate-self', 'rhyming name', 'gives trample', 'synergy-token', 'cards in graveyard matter', 'tribal-dragon', 'discard with set mechanic', 'morbid', 'hate-blocker', 'requires notation', 'manaless value', 'tribal-warrior', 'power boost to all', 'synergy-enchantment', 'synergy-white', 'removal-planeswalker-destroy', 'card types in graveyard matter', 'hate-graveyard', 'virtual vanilla', 'cost-reducer-self', 'trigger from graveyard', 'oversized', 'impulse-land', 'mill-any', 'synergy-legendary', 'gives deathtouch', 'pp counters matter', 'tutor-land-to-battlefield', 'french vanilla', 'discard matters', 'intervening if clause', 'regrowth-self', 'donate token', 'drain life', 'opponent loses life', 'tutor-to-battlefield', 'tribal-vampire', 'burn with set mechanic', 'punny name', 'offcolor ability', 'top deck manipulation', 'saboteur', 'gains menace', 'creaturefall', 'titan trigger', 'toughness matters', 'sacrifice outlet-artifact', 'symmetrical', 'egg', 'tutored by name', 'etb-self', 'gives flying', 'ramp', 'gives hexproof', 'utility land', 'offcolor additional cost', 'gives skulk', 'death trigger', 'tap fuel-creature', 'humble', 'gains haste', 'selective group hug', 'gains lifelink', 'synergy-attacker-self', 'removal-planeswalker-burn', 'tribal-rogue', 'temporary token', 'cantrip', 'draw matters', 'surveil', 'non mana ability mana', 'alliteration', 'synergy-sorcery', 'removal-creature-exile', 'firebreathing', 'portmanteau', 'pair-commander', 'temporary reanimation', 'synergy-sacrifice', 'burn any', 'mix-and-match', 'rummage', 'impulse', 'counterspell-soft', 'removal-creature-bounce', 'theft-cast', 'animate land', 'removal-artifact-destroy', 'pinger', 'bounce-self', 'sweeper-creature-burn', 'gives mana ability', 'synergy-green', 'gains flying', 'unblockable', 'activate from graveyard', 'regrowth-creature', 'delayed triggered ability', 'power matters', 'impulsive draw', 'free-cast-another', 'disenchant/naturalize', 'mulch', 'restricted mana', 'sacrifice outlet-land', 'reanimate-creature', 'cost reducer', 'undergrowth', 'type change', 'mana dork', 'unique mana cost', 'conjure', 'tribal coupling', 'gives vigilance', 'virtual french vanilla', 'cast-from-graveyard', 'heroic', 'removal-creature', 'modal', 'alternate-cost-tap-creature', 'discard', 'protects-creature', 'tapper-creature', 'synergy-artifact', 'evasion', 'dnd monster', 'giant growth', 'gives double strike', 'counters matter', 'animate self', 'tapland', 'discard outlet', 'noncreature tribal', 'synergy-noncreature', 'tribal-wizard', 'tutor-card', 'life payment', 'rescue-creature', 'token generator', 'lifegain', "bear with set's mechanic", 'draw', 'cast trigger-you', 'rhystic', 'burn player', 'flicker-creature', 'fun ruling', 'tome', 'landfall', 'prevent blocker', 'gives first strike', 'repeatable draw', 'removal-creature-fight', 'drawback', 'block trigger', 'tutor-creature', 'interchangeable name', 'poisonous', 'hatebear', 'unique type line', 'hate-counterspell', 'one-sided fight', 'creature count matters', 'synergy-red', 'copy-creature', 'attack trigger', 'hate-artifact', 'graveyard fuel', 'repeatable removal', 'counterspell with set mechanic', 'martyr', 'graveyard fuel-creature', 'consult-cast', 'synergy-blue', 'impulse-onto-battlefield', 'unique counter', 'tribal-cleric', 'shapechange', 'lands matter', 'repeatable crime', 'giant growth with set mechanic', 'fetchable', 'conditional tapland', 'curiosity', 'hate-set-mechanic', 'nonbasic-basic-land-type', 'sacrifice outlet-creature', 'copy-sorcery', 'single english word name', 'life loss matters', 'lifegain matters', 'hate-flying', 'gives haste', 'hate-attacker', 'mill-self', 'gives lifelink', 'refund', 'theft-creature', 'freeze-creature', 'swap removal', 'synergy-vehicle', 'sweeper-creature-destroy', 'free sacrifice outlet', 'copy-instant', 'removal-nonland-bounce', 'hate-tapped', 'synergy-flying', 'synergy-equipment', 'repeatable token generator', 'exponential', 'removal-creature-toughness', 'gives reach', 'impulse-creature', 'removal-creature-destroy', 'damage prevention', 'prevent attack', 'synergy-black', 'boost-power', 'synergy-aura', 'day/night', 'synergy-color-share', 'synergy-token-creature', 'synergy-instant', 'sweeper-one-sided', 'shade pump', 'mana sink', 'combat trick', 'hate-high-pt', 'removal-creature-sacrifice', 'grants flashback', 'mana filter', 'passive ability'}
