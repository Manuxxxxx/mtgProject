...
def append_field_from_bulk_to_processed(
    bulk_file, processed_file, fields_to_append=None
):
    """
...
if __name__ == "__main__":
    ...
    processed_file = (
        "datasets/processed/tag_included/cards_with_tags_20250622170831_copy.json"
    )
