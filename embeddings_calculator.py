...
if __name__ == "__main__":
    create_embedding_file("/home/emanuele/Documenti/Università/ANLP/mtgProject/datasets/processed/embedding_predicted/all_commander_legal_cards20250609112722.json", save_every=300)
